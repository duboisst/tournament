...
export const TABLEAUX: Tableau[] = [
    ...
    new Tableau("8", "2", "Tableau F", "de 500 à 1399", min_classement, 1399, max_numero, toutes_categories, tous_sexes, new Date("05/10/2018 15:00"), 48, 8),
    ...
    new Tableau("11", "2", "Tableau I", "Poussins / Benjamins", min_classement, max_classement, max_numero, ['P', 'B1', 'B2'], tous_sexes, new Date("05/10/2018 18:00"), 24, 5),
